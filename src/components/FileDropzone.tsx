      ...
      <div
        ...
        className={`relative flex flex-col items-center justify-center gap-5 py-16 rounded-2xl border transition-all duration-200 cursor-default select-none overflow-hidden ${
          isDragging
            ...
            : "border-slate-300 dark:border-slate-700/50 bg-slate-50 dark:bg-slate-900/40"
        }`}
      >
        ...
        <div className={`relative w-16 h-16 rounded-2xl flex items-center justify-center transition-all duration-200 ${
          isDragging
            ...
            : "bg-slate-100 dark:bg-slate-800/80 border border-slate-300 dark:border-slate-700/60"
        }`}>
          {isDragging && (
            <div className="absolute inset-0 rounded-2xl bg-blue-500/10 animate-pulse" />
          )}
          <svg
            className={`w-7 h-7 transition-colors relative z-10 ${isDragging ? "text-blue-600 dark:text-blue-400" : "text-slate-500 dark:text-slate-400"}`}
        ...
        <div className="text-center">
          <p className="text-slate-900 dark:text-white font-semibold text-lg mb-1.5">
        ...
        <p className="text-slate-400 dark:text-slate-600 text-xs px-4 text-center">
  ...
  return (
    <div
      ...
      className={`flex items-center justify-center gap-2.5 h-12 rounded-xl border border-dashed cursor-pointer transition-all duration-150 ${
        isDragging
          ? "border-blue-500/60 bg-blue-500/8 text-blue-600 dark:text-blue-400"
          : "border-slate-300 dark:border-slate-700/60 text-slate-500 hover:border-slate-400 dark:hover:border-slate-600 hover:text-slate-800 dark:hover:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-900/40"
      }`}
    >
