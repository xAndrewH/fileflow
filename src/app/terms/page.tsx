    ...
    <div className="min-h-screen bg-white dark:bg-slate-950">
      <div className="max-w-2xl mx-auto px-4 py-16">
        ...
        <div className="prose-slate space-y-8 text-slate-500 dark:text-slate-400 text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-slate-900 dark:text-white font-semibold text-base mb-2">Acceptance</h2>
            <p>
          ...
          <section>
            <h2 className="text-slate-900 dark:text-white font-semibold text-base mb-2">Use of the Service</h2>
          ...
          <section>
            <h2 className="text-slate-900 dark:text-white font-semibold text-base mb-2">Intellectual Property &amp; Copyright</h2>
            <p>
            ...
            <p className="mt-3">
              ...
              <Link href="/dmca" className="text-blue-600 dark:text-blue-400 hover:underline">DMCA Policy</Link>.
            </p>
          </section>

          <section>
            <h2 className="text-slate-900 dark:text-white font-semibold text-base mb-2">Third-Party Services</h2>
            <p>
              ...
              under their{" "}
              <a href="https://cloudconvert.com/terms" className="text-blue-600 dark:text-blue-400 hover:underline" target="_blank" rel="noopener noreferrer">
                Terms of Service
              </a>.
          ...
          <section>
            <h2 className="text-slate-900 dark:text-white font-semibold text-base mb-2">Disclaimer of Warranties</h2>
            <p>
              FileSpark is provided <strong className="text-slate-800 dark:text-slate-200">"as is"</strong> without warranties of
          ...
          <section>
            <h2 className="text-slate-900 dark:text-white font-semibold text-base mb-2">Limitation of Liability</h2>
            <p>
          ...
          <section>
            <h2 className="text-slate-900 dark:text-white font-semibold text-base mb-2">Indemnification</h2>
            <p>
          ...
          <section>
            <h2 className="text-slate-900 dark:text-white font-semibold text-base mb-2">Governing Law</h2>
            <p>
          ...
          <section>
            <h2 className="text-slate-900 dark:text-white font-semibold text-base mb-2">Service Availability</h2>
            <p>
          ...
          <section>
            <h2 className="text-slate-900 dark:text-white font-semibold text-base mb-2">Changes to These Terms</h2>
            <p>
          ...
          <section>
            ...
            <p>
              ...
              <a href="mailto:legal@filespark.app" className="text-blue-600 dark:text-blue-400 hover:underline">legal@filespark.app</a>.
            </p>
          </section>
