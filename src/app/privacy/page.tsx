    ...
    <div className="min-h-screen bg-white dark:bg-slate-950">
      <div className="max-w-2xl mx-auto px-4 py-16">
        ...
        <div className="prose-slate space-y-8 text-slate-500 dark:text-slate-400 text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-slate-900 dark:text-white font-semibold text-base mb-2">Files You Upload</h2>
            <p>
              Files you upload for conversion are processed solely for the purpose of converting them.
              They are <strong className="text-slate-800 dark:text-slate-200">never stored, logged, shared, or sold</strong>.
          ...
          <section>
            <h2 className="text-slate-900 dark:text-white font-semibold text-base mb-2">Conversion History</h2>
            <p>
              FileSpark stores a history of your past conversions (file names, sizes, formats) locally in your
              browser&apos;s <code className="text-slate-700 dark:text-slate-300 bg-slate-100 dark:bg-slate-800 px-1 py-0.5 rounded text-xs">localStorage</code>.
              This data never leaves your device. You can clear it at any time from the History panel.
            </p>
          </section>

          <section>
            <h2 className="text-slate-900 dark:text-white font-semibold text-base mb-2">Cookies &amp; Tracking</h2>
            <p>
          ...
          <section>
            <h2 className="text-slate-900 dark:text-white font-semibold text-base mb-2">Third-Party API (CloudConvert)</h2>
            <p>
              Document and eBook conversions optionally use{" "}
              <a href="https://cloudconvert.com" className="text-blue-600 dark:text-blue-400 hover:underline" target="_blank" rel="noopener noreferrer">CloudConvert</a>.
              ...
              <a href="https://cloudconvert.com/privacy" className="text-blue-600 dark:text-blue-400 hover:underline" target="_blank" rel="noopener noreferrer">
                Privacy Policy
              </a>.
          ...
          <section>
            <h2 className="text-slate-900 dark:text-white font-semibold text-base mb-2">Hosting</h2>
            <p>
              FileSpark is hosted on <a href="https://vercel.com" className="text-blue-600 dark:text-blue-400 hover:underline" target="_blank" rel="noopener noreferrer">Vercel</a>.
              ...
              <a href="https://vercel.com/legal/privacy-policy" className="text-blue-600 dark:text-blue-400 hover:underline" target="_blank" rel="noopener noreferrer">
          ...
          <section>
            <h2 className="text-slate-900 dark:text-white font-semibold text-base mb-2">GDPR (European Users)</h2>
            <p>
            ...
            <p className="mt-3">
              ...
              <a href="mailto:privacy@filespark.app" className="text-blue-600 dark:text-blue-400 hover:underline">privacy@filespark.app</a>.
            </p>
          </section>

          <section>
            <h2 className="text-slate-900 dark:text-white font-semibold text-base mb-2">CCPA (California Users)</h2>
            <p>
          ...
          <section>
            <h2 className="text-slate-900 dark:text-white font-semibold text-base mb-2">Children&apos;s Privacy</h2>
            <p>
          ...
          <section>
            <h2 className="text-slate-900 dark:text-white font-semibold text-base mb-2">Changes to This Policy</h2>
            <p>
          ...
          <section>
            <h2 className="text-slate-900 dark:text-white font-semibold text-base mb-2">Contact</h2>
            <p>
